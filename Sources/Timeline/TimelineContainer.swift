...
//    timeline.offsetAllDayView(by: contentOffset.y)
    ...
    timeline.offsetAllDayEventView(by: contentOffset.y)
    
    
    //adjust the scroll insets
//    let allDayViewHeight = timeline.allDayViewHeight
    let allDayHeadarHeight = timeline.allDaySummaryViewHeight + timeline.allDayEventViewHeight
    ...
    scrollIndicatorInsets = UIEdgeInsets(top: allDayHeadarHeight, left: 0, bottom: bottomSafeInset, right: 0)
    contentInset = UIEdgeInsets(top: allDayHeadarHeight, left: 0, bottom: bottomSafeInset, right: 0)
  }
